...
<html lang="en">
    ...
    <head>
        ...
        <title>Caspero Home</title>
    </head>
    <body>
        <header class = "jumbotron jumbotron-fluid mt-3">
            <div class = "container">
                <div class = "col-16 mt-5">
                    <h2 class = "text-center text-primary">Caspero User Dashboard</h2>

                    <?php
                    echo $session_data['user_id'];
